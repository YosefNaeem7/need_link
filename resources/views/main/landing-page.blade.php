      ...
      <div class="row align-items-center g-5">
        ...
        <div class="col-lg-6">
          ...
          <div class="d-flex flex-wrap gap-3 mb-4">
            <a href="{{ route('register') }}" class="btn btn-primary-custom btn-lg px-5 fw-bold">إنشاء حساب</a>
            <a href="{{ route('login') }}" class="btn btn-outline-custom btn-lg px-5 fw-bold">تسجيل الدخول</a>
          </div>
        ...
        <div class="col-lg-4 col-md-6">
          <div class="card service-card h-100 border rounded-4 overflow-hidden">
            ...
            <div class="card-body p-4">
              ...
              <a href="{{ route('register') }}" class="fw-bold text-blue text-decoration-none">ابدأ الطلب</a>
            </div>
          </div>
        </div>
        ...
        <div class="col-lg-4 col-md-6">
          <div class="card service-card h-100 border rounded-4 overflow-hidden">
            ...
            <div class="card-body p-4">
              ...
              <a href="{{ route('register') }}" class="fw-bold text-blue text-decoration-none">انشر احتياجك</a>
            </div>
          </div>
        </div>
        ...
        <div class="col-lg-4 col-md-6 mx-md-auto">
          <div class="card service-card h-100 border rounded-4 overflow-hidden">
            ...
            <div class="card-body p-4">
              ...
              <a href="{{ route('register') }}" class="fw-bold text-blue text-decoration-none">انضم كمزود</a>
            </div>
          </div>
        </div>
  ...
  <section class="py-5">
    <div class="container">
      <div class="cta-box text-center rounded-5 p-5 text-white">
        ...
        <a href="{{ route('register') }}" class="btn btn-light btn-lg px-5 fw-bold text-blue">انضم الآن</a>
      </div>
    </div>
  </section>
@endsection